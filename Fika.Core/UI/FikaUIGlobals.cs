...
namespace Fika.Core.UI
{
    public static class FikaUIGlobals
    {
        ...
        public static GClass3590 ShowFikaMessage(this PreloaderUI preloaderUI, string header, string message,
            ErrorScreen.EButtonType buttonType, float waitingTime, Action acceptCallback, Action endTimeCallback)
        {
            ...
            PreloaderUI.Class2843 messageHandler = new()
            {
        ...
        public static GClass3595 ShowFikaMessage(this ErrorScreen errorScreen, string title, string message,
            ...
            ErrorScreen.EButtonType buttonType = ErrorScreen.EButtonType.OkButton, bool removeHtml = true)
        {
            ...
            errorScreenHandler.context = (GClass3595)baseShow.Invoke(errorScreen, []);
