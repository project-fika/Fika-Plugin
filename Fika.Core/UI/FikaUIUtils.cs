...
namespace Fika.Core.UI
{
    internal static class FikaUIUtils
    {
        ...
        public static GClass3102 ShowFikaMessage(this PreloaderUI preloaderUI, string header, string message,
            ErrorScreen.EButtonType buttonType, float waitingTime, Action acceptCallback, Action endTimeCallback)
        {
            ...
            PreloaderUI.Class2590 messageHandler = new()
            {
        ...
        public static GClass3104 ShowFikaMessage(this ErrorScreen errorScreen, string title, string message,
