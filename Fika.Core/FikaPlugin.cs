...
namespace Fika.Core
{
    ...
    public class FikaPlugin : BaseUnityPlugin
    {
        ...
        private void SetupConfig()
        {
            ...
            DespawnMinimumDistance = Config.Bind("Performance | Max Bots", "Despawn Minimum Distance", false, new ConfigDescription("", tags: new ConfigurationManagerAttributes() { Order = 12 }));
