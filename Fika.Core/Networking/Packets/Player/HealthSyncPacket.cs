...
namespace Fika.Core.Networking
{
    public struct HealthSyncPacket(int netId) : INetSerializable
    {
        ...
        {
            NetId = reader.GetInt();
            GStruct349 packet = new()
            {
                SyncType = (GStruct349.ESyncType)reader.GetInt()
            };
            switch (packet.SyncType)
            {
                case GStruct349.ESyncType.AddEffect:
                    {
                        packet.Data.AddEffect = new()
                        {
                            ...
                            ExtraDataType = (GStruct349.GStruct350.EExtraDataType)reader.GetInt()
                        };
                        switch (packet.Data.AddEffect.ExtraDataType)
                        {
                            case GStruct349.GStruct350.EExtraDataType.MedEffect:
                                {
                                ...
                                break;
                            case GStruct349.GStruct350.EExtraDataType.Stimulator:
                                {
                                    packet.Data.AddEffect.ExtraData = new()
                                    {
                                        Stimulator = new()
                ...
                case GStruct349.ESyncType.RemoveEffect:
                    {
                ...
                case GStruct349.ESyncType.EffectNextState:
                    {
                ...
                case GStruct349.ESyncType.EffectStateTime:
                    {
                ...
                case GStruct349.ESyncType.EffectStrength:
                    {
                ...
                case GStruct349.ESyncType.EffectMedResource:
                    {
                ...
                case GStruct349.ESyncType.EffectStimulatorBuff:
                    {
                ...
                case GStruct349.ESyncType.IsAlive:
                    {
                ...
                case GStruct349.ESyncType.BodyHealth:
                    {
                ...
                case GStruct349.ESyncType.Energy:
                    {
                ...
                case GStruct349.ESyncType.Hydration:
                    {
                ...
                case GStruct349.ESyncType.Temperature:
                    {
                ...
                case GStruct349.ESyncType.DamageCoeff:
                    {
                ...
                case GStruct349.ESyncType.ApplyDamage:
                    {
                ...
                case GStruct349.ESyncType.DestroyedBodyPart:
                    {
                ...
                case GStruct349.ESyncType.HealthRates:
                    {
                ...
                case GStruct349.ESyncType.HealerDone:
                    {
                ...
                case GStruct349.ESyncType.BurnEyes:
                    {
                ...
                case GStruct349.ESyncType.Poison:
                    {
                ...
                case GStruct349.ESyncType.StaminaCoeff:
                    {
        ...
        {
            writer.Put(NetId);
            GStruct349.GStruct368 packet = Packet.Data;
                ...
                case GStruct349.ESyncType.AddEffect:
                    {
                        ...
                        {
                            case GStruct349.GStruct350.EExtraDataType.None:
                                break;
                            case GStruct349.GStruct350.EExtraDataType.MedEffect:
                                {
