...
/// </summary>
internal class Minefield_Explode_Patch : ModulePatch
{
    protected override MethodBase GetTargetMethod()
    {
        return typeof(Minefield).GetMethod(nameof(Minefield.Explode));
    }
        ...
        float secondExplosionDamage, Minefield minefield)
    {
        ...
        if (fikaPlayer != null)
        {
            ...
            var enumerable = isCollateral ? player.PlayerBones.BodyPartColliders.Where(minefield.CG_DealExplosionDamage)
                : player.PlayerBones.BodyPartColliders.Where(minefield.CG_DealExplosionDamage1);
