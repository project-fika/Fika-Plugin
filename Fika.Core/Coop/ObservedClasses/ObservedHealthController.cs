...
namespace Fika.Core.Coop.ObservedClasses
{
        ...
        : NetworkHealthControllerAbstractClass(serializedState, inventory, skills)
    {
        ...
        public override bool ApplyItem(Item item, GStruct350<EBodyPart> bodyPart, float? amount = null)
        {
            return false;
        }
        ...
        public void PauseAllEffects()
        {
            ...
            for (int i = list_1.Count - 1; i >= 0; i--)
            {
                ...
                PausedEffectsStruct gstruct = gclass811_0.Withdraw();
        ...
        public override Profile.ProfileHealthClass Store(Profile.ProfileHealthClass health = null)
        {
            ...
            if ((profileHealthClass = health) == null)
            {
                ...
                {
                    BodyParts = GClass842<EBodyPart>.GetDictWith<Profile.ProfileHealthClass.GClass1970>(),
            ...
            foreach (KeyValuePair<EBodyPart, BodyPartState> keyValuePair in Dictionary_0)
            {
                ...
                if (!health.BodyParts.TryGetValue(ebodyPart2, out Profile.ProfileHealthClass.GClass1970 gclass))
                {
                    gclass = new Profile.ProfileHealthClass.GClass1970();
            ...
            foreach (NetworkBodyEffectsAbstractClass gclass in IReadOnlyList_0)
            {
                ...
                {
                    Profile.ProfileHealthClass.GClass1970 gclass2 = health.BodyParts[gclass.BodyPart];
                    gclass2.Effects ??= [];
        ...
        private class EffectHandler(ObservedHealthController healthController)
        {
            ...
            public void UnpauseEffects()
            {
                for (int i = PausedEffects.Count - 1; i >= 0; i--)
                {
                    ...
                    healthController.gclass811_0.Return(PausedEffectsInfo[i]);
                }
            }
        }
    }
