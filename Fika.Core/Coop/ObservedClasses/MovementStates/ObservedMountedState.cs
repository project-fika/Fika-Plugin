...
namespace Fika.Core.Coop.ObservedClasses
{
	public class ObservedMountedState : MovementState
	{
		...
		public override void Enter(bool isFromSameState)
		{
			...
			bool_1 = false;
			player.OnMounting(GStruct173.EMountingCommand.Enter);
		...
		public override void Exit(bool toSameState)
		{
			...
			MovementContext.MountedSmoothedTilt = 0f;
			MovementContext.MountedSmoothedTiltForCamera = 0f;
			MovementContext.SetYawLimit(Player.GClass1687.FULL_YAW_RANGE);
			MovementContext.SetPitchSmoothly(MovementContext.IsInPronePose ? Player.GClass1687.PRONE_POSE_ROTATION_PITCH_RANGE : Player.GClass1687.STAND_POSE_ROTATION_PITCH_RANGE);
		...
		public override void ManualAnimatorMoveUpdate(float deltaTime)
		{
			...
			if (float_4 <= playerMountingPointData.CurrentApproachTime)
			{
				...
				player.OnMounting(GStruct173.EMountingCommand.Update);
				return;
			}
		...
		public void StartExiting()
		{
			...
			player.OnMounting(GStruct173.EMountingCommand.StartLeaving);
			Action<float> onExitMountedState = playerMountingPointData.OnExitMountedState;
			if (onExitMountedState == null)
			{
				return;
