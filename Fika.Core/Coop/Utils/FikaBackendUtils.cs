...
namespace Fika.Core.Coop.Utils
{
    ...
    public static class FikaBackendUtils
    {
        ...
        internal static GClass3864<GClass1337> GroupPlayers { get; set; } = [];
        ...
        public static GClass1364 TransitData
        {
            get
            {
                if (transitData == null)
        ...
        private static GClass1364 transitData;
        ...
        internal static void AddPartyMembers(Dictionary<Profile, bool> profiles)
        {
            ...
            foreach (KeyValuePair<Profile, bool> kvp in profiles)
            {
                ...
                GClass1337 visualProfile = new(infoSet)
                {
