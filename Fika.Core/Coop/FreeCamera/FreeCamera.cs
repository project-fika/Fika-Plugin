...
#if DEBUG
					FikaPlugin.Instance.FikaLogger.LogInfo($"Freecam SERVER: There are {players.Count} players");
#endif
				}
				else
				{
...
#if DEBUG
					FikaPlugin.Instance.FikaLogger.LogInfo($"Freecam CLIENT: There are {players.Count} players");
#endif
				}
			}
